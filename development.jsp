...
<pre class="codeSample">   String#contains()
   ...
   $[ja:インターフェースにおける ]$[en:Use of ]@Override $[ja:アノテーション]$[en:annotation in interface]
</pre>
    </p>
    </tag:h2>
...
<br><a href="http://www.atlassian.com/c/NPOS/10160"><img src="./images/jira_button_120wx60h.gif" width="120" height="60"/></a>
    ...
    <p>$[ja:Twitter4Jは継続ビルドに <a href="http://twitter4j.org/jenkins/job/T4J/">Jenkins</a> を使っています。]$[en:Twitter4J is built continuously by <a href="http://twitter4j.org/jenkins/job/T4J/">Jenkins</a>.]
    </p>
