...
パラメータなしの getFriendsStatuses() と getFollowersStatuses() は getFriendsStatuses(-1) または getFollowersStatuses(-1l) を呼び出すのと同じで、最初のページを返します。<br>
<br>]
...
getFriendsStatuses() and getFollowersStatuses() (with no parameter) are handy methods which are equivalent calls to getFriendsStatuses(-1) and getFollowersStatuses(-1l) which retrieve the first page.<br>
<br>]
