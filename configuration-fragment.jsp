...
<tr><td>includeEntities</td><td>$[ja:タイムイン取得メソッドの返り値に追加情報を含めるかどうかのフラグ。]$[en:If set to true, entities will be included in the timeline methods' resopnse.]</td><td>false</td></tr>
...
<tr><td>http.useSSL</td><td>$[ja:SSL接続有効化フラグ]$[en:Enables SSL connection.]</td><td>$[ja:Basic認証では true, OAuth認可では false]$[en:true for Basic auth, false for OAuth]</td></tr>
...
<tr><td>media.provider</td><td>$[ja:デフォルトメディアプロバイダ]$[en:default media provider]<br>$[ja:サポートされるプロバイダ]$[en:Supported providers]:<br>imgly, plixi, twipple, twitgoo, twitpic, yfrog</td><td>yrfog</td></tr>
