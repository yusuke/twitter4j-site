...
$[ja:標準的なプロパティファイルを &quot;twitter4j.properties&quot; という名前で保存します。 &quot;twitter4j.properties&quot; はカレントディレクトリ、クラスパスのルート、または WEB-INF/ ディレクトリに配置してください。]$[en:Save a standard properties file named &quot;twitter4j.properties&quot;. Place it to either the current directory, root of the classpath or WEB-INF/ directory.]
