...
$[ja:Basic認証の廃止に伴いTwitterFactory.getInstance(screenName,password)は廃止されました。xAuthでアクセストークンを取得するには<a href="http://twitter4j.org/en/javadoc-latest/core/twitter4j/auth/OAuthSupport.html#getOAuthAccessToken(java.lang.String,%20java.lang.String)">Twitter.getOAuthAccessToken(screenName, password)</a>を使います。getOAuthAuthorizedInstance(Authorization) は廃止され、getInstance(Authorization)になりました。<br>]
$[en:TwitterFactory.getInstance(screenName,password) was retired. To get an access token using xAuth flow, use <a href="http://twitter4j.org/en/javadoc-latest/core/twitter4j/auth/OAuthSupport.html#getOAuthAccessToken(java.lang.String,%20java.lang.String)">Twitter.getOAuthAccessToken(screenName, password)</a>. getOAuthAuthorizedInstance(Authorization) was retired, use getInstance(Authorization) instead.<br>]
<br>
