...
<tr><td>includeMyRetweet</td><td>$[ja:trueにセットするとリイートしたステータスのIDをStatus#getCurrentUserRetweetId()で取得できる。]$[en:set to true, any statuses returned that have been retweeted by the authenticating user will include an additional field: Status#getCurrentUserRetweetId ()]</td><td>true</td></tr>
...
<tr><td>loggerFactory</td><td>$[ja:ログ出力実装]$[en:Logger implimentation]<br>$[ja:サポートされる実装]$[en:Supported implimentations]:<br>&nbsp;twitter4j.StdOutLoggerFactory<br>&nbsp;twitter4j.SLF4JLoggerFactory<br>&nbsp;twitter4j.CommonsLoggingLoggerFactory<br>&nbsp;twitter4j.Log4JLoggerFactory<br>&nbsp;twitter4j.JULLoggerFactory<br>&nbsp;twitter4j.NullLoggerFactory</td><td>null</td></tr>
...
<tr><td>stream.user.repliesAll</td><td>$[ja:replies=all を有効化する]$[en:enables replies=all parameter]</td><td>false</td></tr>
...
<tr><td>restBaseURL</td><td>REST API $[ja:ベース]$[en:base] URL</td><td>https://api.twitter.com/1.1/</td></tr>
<tr><td>streamBaseURL</td><td>Streaming API $[ja:ベース]$[en:base] URL</td><td>https://stream.twitter.com/1.1/</td></tr>
...
<tr><td>oauth.requestTokenURL</td><td>OAuth request token URL</td><td>https://api.twitter.com/oauth/request_token</td></tr>
<tr><td>oauth.accessTokenURL</td><td>OAuth access token URL</td><td>https://api.twitter.com/oauth/access_token</td></tr>
<tr><td>oauth.authorizationURL</td><td>OAuth authorization URL</td><td>https://api.twitter.com/oauth/authorize</td></tr>
<tr><td>oauth.authenticationURL</td><td>OAuth authentication URL</td><td>https://api.twitter.com/oauth/authenticate</td></tr>
...
<tr><td>async.dispatcherImpl</td><td>$[ja:非同期処理実装クラス名]$[en:Asynchronous dispatcher implementation class name]</td><td>twitter4j.DispatcherImpl</td></tr>
<tr><td>async.daemonEnabled</td><td>$[ja:非同期処理スレッドをデーモンにするかどうか]$[en:Specifies if async threads shouldd be daemons]</td><td>true</td></tr>
</table></tag:h3>