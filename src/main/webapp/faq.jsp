    ...
    <div class="faq">
        <ol class="main">
            ...
            <tag:h3-num name="appname"
                        title="$[ja:twitter.com で from Twitter4J のかわりに自分のアプリケーション名を表示させるにはどうすれば良いですか？]$[en:How do I get “from Twitter4J” appended to updates sent from my application?]">
            ...
            $[en:In order to get your app name seen on twitter.com, you need to register your application at <a
                href="http://twitter.com/oauth_clients/new">twitter.com</a> in advance, and use OAuth scheme.]
            ...
            <ul>
                ...
                <li class="numberedlist">
                    <a href="http://jira.twitter4j.org/browse/TFJ?report=com.atlassian.jira.plugin.system.project:roadmap-panel">Twitter4J
                        $[ja:ロードマップ]$[en: Road Map]</a>
                </li>
            </ul>
            </tag:h3-num>
            <tag:h3-num name="proxy"
                        title="$[ja:プロキシサーバはどうやって設定しますか？]$[en:How do I configure proxy server for Twitter4J?]">
...
http.proxyPort=8080
            ...
            in the process's default directory.]<br>

            </tag:h3-num>
            <tag:h3-num name="debug"
                        title="$[ja:Twitter4J をつかったアプリケーションをデバッグする良い方法はありますか？]$[en:How do I debug my application?]">
            ...
            <tag:h3-num name="compile"
                        title="$[ja:コード例が私の環境(Java1.4)ではコンパイルできません。]$[en:The code examples don't compile on my environment(Java1.4).]">
