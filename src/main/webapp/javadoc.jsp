...
<tag:skelton title="Twitter4J - JavaDoc"
    ...
    <div class="javadoc">
        ...
        <tag:h2 name="latest-snapshot" title="$[ja:最新安定ビルド]$[en:Latest stable build]$[ko:최신 안정 빌드]">
            ...
            <a href="/oldjavadocs/<include>latest-version.fragment</include>-<include>latest-SNAPSHOT-version.fragment</include>/changes.html">･$[ja:バージョン<include>latest-version.fragment</include>からの JavaDoc diff]$[en:JavaDoc diff from Version]$[ko:버전<include>latest-version.fragment</include>부터의 JavaDoc diff]<include>latest-version.fragment</include>
            </a>

            <p>･$[ja:バージョン]$[en:version]$[ko:버전] 4.0.x<br>
                <%@ include file="oldjavadocs40x.jsp" %>
            </p>
            <a href="http://twitter4j.org/oldjavadocs/3.0.6-4.0.0/changes.html">･JavaDoc diff from $[ja:バージョン]$[en:version]$[ko:버전] 3.0.6-4.0.0</a><br>
            <br>

            <p>･$[ja:バージョン]$[en:version]$[ko:버전] 3.0.x<br>
                <%@ include file="oldjavadocs30x.jsp" %>
            </p>
            <a href="http://twitter4j.org/oldjavadocs/2.2.6-3.0.0/changes.html">･JavaDoc diff from $[ja:バージョン]$[en:version]$[ko:버전] 2.2.6-3.0.0</a><br>
            <br>

            <p>･$[ja:バージョン]$[en:version]$[ko:버전] 2.2.x<br>
                <%@ include file="oldjavadocs22x.jsp" %>
            </p>
            <a href="http://twitter4j.org/oldjavadocs/2.1.12-2.2.6/changes.html">･JavaDoc diff from $[ja:バージョン]$[en:version]$[ko:버전] 2.1.12-2.2.6</a><br>
            <br>
        ...
        <tag:h2 name="oldVersions" title="$[ja:古いバージョンの JavaDoc と差分]$[en:Old JavaDocs and diffs]$[ko:오래된 버전의 JavaDoc 와의 diff]">
            <a href="/oldjavadocs/2.0.10-2.1.0/changes.html">･JavaDoc diff from $[ja:バージョン]$[en:version]$[ko:버전] 2.0.10 to 2.1.0</a><br>
