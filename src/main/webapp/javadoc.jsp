    ...
    <div class="javadoc">
        ...
        <tag:h2 name="latest-snapshot" title="$[ja:最新安定ビルド]$[en:Latest stable build]">
            ...
            <a href="/oldjavadocs/<include>latest-version.fragment</include>-<include>latest-SNAPSHOT-version.fragment</include>/changes.html">･$[ja:バージョン
                <include>latest-version.fragment</include>
                からの JavaDoc diff]$[en:JavaDoc diff from Version]
                <include>latest-version.fragment</include>
            </a>

            <p>･$[ja:バージョン]$[en:version] 3.0.x<br>
                <%@ include file="oldjavadocs30x.jsp" %>
            </p>
            <a href="http://twitter4j.org/oldjavadocs/2.2.6-3.0.0/changes.html">$[ja:バージョン]$[en:version] 2.2.6-3.0.0</a><br>
            <br>

            <p>･$[ja:バージョン]$[en:version] 2.2.x<br>
                <%@ include file="oldjavadocs22x.jsp" %>
            </p>
            <a href="http://twitter4j.org/oldjavadocs/2.1.12-2.2.6/changes.html">$[ja:バージョン]$[en:version]
                2.1.12-2.2.6</a><br>
            <br>
